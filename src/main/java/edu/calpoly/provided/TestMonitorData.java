 ...
 *
 * <p>The generator sends ROBOT, GAZE, AFFECT, and LIDAR messages through one
 * receive connection. During each cycle, one source temporarily stops sending
 * so monitoring applications can detect loss and recovery.</p>
 */
